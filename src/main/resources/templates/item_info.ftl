        ...
        <div class="card horizontal">
            ...
            <div class="card-stacked">
                <div class="card-content">
                    ...
                    <p> ${item.price} rub</p>
                    <p>${item.storage} ps</p>
                    <p><a style="margin-top: 30px; margin-bottom: 30px" href="/basket" class="waves-effect waves-light btn">buy</a></p>
                </div>
                <div class="card-action">
                    ...
                    <div id="description" style="margin: 0 0 10px 10px; display:none">${item.description}</div>
                </div>
            </div>
        </div>
    </div>
